                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post">
                                ...
                                <button type="submit" name="ubah_status" class="btn btn-sm btn-success">Ubah Status</button>
                            </form>
                        </td>
                    </tr>
                <?php } ?>
                <?php if (mysqli_num_rows($result) == 0) { ?>
                    <tr><td colspan="7" class="text-center">Tidak ada pesanan yang sesuai filter.</td></tr>
                <?php } ?>
                </tbody>
            </table>
        </div>
