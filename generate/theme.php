    ...
    <script>
      document.addEventListener('DOMContentLoaded', () => {
        ...
        function updateSidebar() {
          ...
          sidebarColorCode.innerHTML = `<pre><code class="language-php">&lt;aside class="app-sidebar ${sidebarBg}" data-bs-theme="${sidebarColorMode}"&gt;...&lt;/aside&gt;</code></pre>`;
        }
      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        function updateNavbar() {
          ...
          navbarColorCode.innerHTML = `<pre><code class="language-php">&lt;nav class="app-header navbar navbar-expand ${navbarBg}" data-bs-theme="${navbarColorMode}"&gt;...&lt;/nav&gt;</code></pre>`;
        }
      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        function updateFooter() {
          ...
          footerColorCode.innerHTML = `<pre><code class="language-php">&lt;footer class="app-footer ${footerBg}" data-bs-theme="${footerColorMode}"&gt;...&lt;/footer&gt;</code></pre>`;
        }
